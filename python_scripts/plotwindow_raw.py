...
class PlotWindow(QWidget):
    ...
    def update(self):
       ...
       # print(f"frequency: {peak_freq}, DPS: {peak_freq*360}")
        ...
        self.curve1.setData(self.t,acc_x)
        self.curve3.setData(self.t,acc_y)
        self.curve4.setData(self.t,acc_z)
        self.curve5.setData(self.freqs,g_x)
        self.curve6.setData(self.freqs,g_y)
        self.curve7.setData(self.freqs,g_z)
